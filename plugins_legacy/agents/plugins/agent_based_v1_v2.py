...
IMPORTS_ADDED = "from collections.abc import Sequence\nfrom cmk.agent_based.v1 import check_levels\nfrom cmk.agent_based.v2 import AgentSection, SNMPSection, SimpleSNMPSection, CheckPlugin, InventoryPlugin, RuleSetType, CheckResult, DiscoveryResult, StringTable, get_value_store, StringByteTable\n\n"
